...
A beautiful, interactive mini website I built to celebrate my friend’s special day ❤️.  
...
## 🚀 Live Demo  
👉 [Click here to view the site](https://itachithesixpathsage.github.io/HappyBirthdayGF)  
...
1. Clone the repo:  
   ```bash
   git clone https://github.com/itachithesixpathsage/HappyBirthdayGF.git
